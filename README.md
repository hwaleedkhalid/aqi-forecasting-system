...
* **Hourly Live Feature Pipeline**: The feature pipeline runs automatically every hour via GitHub Actions (`.github/workflows/feature_pipeline.yml`, cron schedule `17 * * * *`). Automated cloud execution was verified in production workflow run [34152458548](https://github.com/hwaleedkhalid/aqi-forecasting-system/actions/runs/34152458548), fetching live 72h OpenWeather pollution telemetry and Open-Meteo meteorology, verifying temporal grid continuity, computing canonical 114 features, and mutating Hopsworks Feature Store with zero latency regressions.
